...
<body style="background-color: #72DBFF;">
    ...
    <div style="margin-bottom: 35px;">
        ...
        } else if (isset($_GET['purification-system'])) {
            if (isset($_GET['action']) && $_GET['action'] == "new")
                require_once('source/include/technic_pages/add_purification_system_control.php');
            if (isset($_GET['action']) && $_GET['action'] == "view")
                require_once('source/include/technic_pages/view_purification_system_control.php');
