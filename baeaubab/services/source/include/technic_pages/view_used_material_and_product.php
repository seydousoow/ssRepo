...
<script>
    document.getElementById("dateSelector").addEventListener("change", function () {
        ...
        location.href =
            "technic_homepage.php?maintenance&section=mat_prod&action=view&year=" +
            year;
    });
</script>
...
<table class="tg" style="table-layout: fixed; width: auto">
    ...
    <tr>
        <td class="tg-7miv" colspan="3">MATÉRIELS ET PRODUITS UTILISÉS POUR L'ENTRETIEN <br>
        DES RÉSERVOIRS D'EAU ET DES LIGNES D'EMBOUTEILLAGE</td>
    </tr>
    <tr>
