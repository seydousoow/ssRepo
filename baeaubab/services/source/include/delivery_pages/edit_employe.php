...
<div class="delivery_employe_container new-emp-page">
    ...
    <div id="edit-emp-container">
        <div class="edit-cont">
            <p class="delivery-employe-title">
                Se&#769;lectioner l'employe&#769; à e&#769;diter
            </p>
        ...
        <div class="edit-cont">
            ...
            <form style="width:500px" method="post" action="source/model/delivery/M_edit_employe.php">
                ...
                <input class="btn btn-primary submit_new_emp" type="submit" name="submit_edit_emp" value="Modifier">
            </form>
        </div>
    </div>
